...
import com.justo.dto.util.ErrorDTO;
...
public class APIExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(JustoException.class)
    public ResponseEntity<ErrorDTO> duplicateResource(JustoException e, WebRequest request) {
